package game.objects.enemy {
	...
	public class Enemy_8 extends EnemyBase {
		public function Enemy_8(_x:Number, _y:Number, _hitRect:Rectangle, _healthScaling:Number=1, _createsPowerup:Boolean=false) {
			baseCashValue=1
			basePointsValue=25
			...
			currentTargetX=_x
			currentTargetY=_y
			super(_x, _y, OBJECT_TYPE.ENEMY_8, _hitRect, _healthScaling, _createsPowerup)
			health=1
