package game.objects.enemy {
	...
	public class Enemy_2 extends EnemyBase {
		public function Enemy_2(_x:Number, _y:Number, _hitRect:Rectangle, _healthScaling:Number=1, _createsPowerup:Boolean=false) {
			baseCashValue=1
			basePointsValue=25
			...
			currentTargetX=_x
			currentTargetY=_y
			super(_x, _y, OBJECT_TYPE.ENEMY_2, _hitRect, _healthScaling, _createsPowerup)
			health=1
