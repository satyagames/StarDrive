package game.objects.enemy {
	...
	public class Enemy_6 extends EnemyBase {
		public function Enemy_6(_x:Number, _y:Number, _hitRect:Rectangle, _healthScaling:Number=1, _createsPowerup:Boolean=false) {
			baseCashValue=1
			basePointsValue=25
			...
			currentTargetX=_x
			currentTargetY=_y
			super(_x, _y, OBJECT_TYPE.ENEMY_6, _hitRect, _healthScaling, _createsPowerup)
			health=1
